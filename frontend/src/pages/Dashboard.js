  ...
  const metrics = [
    {
      ...
      color: 'text-blue-600',
      bg: 'bg-blue-50',
      testid: 'metric-total-socios'
    },
    {
      title: 'Socios Activos',
      value: stats?.socios_activos || 0,
      icon: UserCheck,
      color: 'text-green-600',
      bg: 'bg-green-50',
      testid: 'metric-socios-activos'
    },
    {
      title: 'Socios Vencidos',
      value: stats?.socios_vencidos || 0,
      icon: UserX,
      color: 'text-red-600',
      bg: 'bg-red-50',
      testid: 'metric-socios-vencidos'
    },
    {
