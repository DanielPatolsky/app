...
function SocioModal({ socio, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (socio) {
        await axios.put(`${BACKEND_URL}/api/socios/${socio.socio_id}`, formData, {
          headers: { Authorization: `Bearer ${token}` }
        });
        toast.success('Socio actualizado correctamente');
      } else {
        await axios.post(`${BACKEND_URL}/api/socios`, formData, {
          headers: { Authorization: `Bearer ${token}` }
        });
      ...
      toast.error(error.response?.data?.detail || 'Error al guardar el socio');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/50 flex items-center justify-center z-50 p-4" data-testid="socio-modal">
      <div className="bg-white rounded-xl shadow-lg max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              type="tel"
              data-testid="socio-telefono-input"
          ...
          <div>
            ...
            <input
              type="text"
              data-testid="socio-direccion-input"
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              data-testid="submit-socio-button"
              disabled={loading}
